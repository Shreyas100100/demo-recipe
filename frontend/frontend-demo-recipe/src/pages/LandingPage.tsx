import { ChefHat, Search, Clock, BookOpen, Users, ChevronRight } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              <button onClick={handleButtonClick} className="px-4 py-2 text-gray-600 hover:text-gray-900 font-medium">
                Log in
              </button>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-6 text-lg text-gray-600">
                Join our community of food enthusiasts. Find inspiration, share your creations, and connect with cooks worldwide.
              </p>
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <button className="px-6 py-3 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors font-medium flex items-center justify-center">
                  Get Started Free
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">Find recipes that fit your schedule with detailed timing information.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <BookOpen className="h-10 w-10 text-orange-500 mb-4" />
              <h3 className="text-xl font-semibold mb-2">Recipe Collections</h3>
              <p className="text-gray-600">Create and share your personal cookbook with your favorite recipes.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <Users className="h-10 w-10 text-orange-500 mb-4" />
              <h3 className="text-xl font-semibold mb-2">Community</h3>
              <p className="text-gray-600">Connect with other food lovers and share your culinary journey.</p>
            </div>
          </div>
        </div>
      </div>
